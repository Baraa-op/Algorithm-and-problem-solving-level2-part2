...
void Copy_Odd_Number_From_Array(int arr[100] , int ArrLength , int arr2[100] , int &Arr2Length)
{
    for(int i = 0 ; i < ArrLength; i++)
    {
...
int main()
{
    ...
    cout << "\n" ;
    cout << "odd number in array : " ;
    Copy_Odd_Number_From_Array(arr , ArrLength , arr2 , Arr2Length);
